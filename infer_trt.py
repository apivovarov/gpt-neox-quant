...
attention_mask = np.array([[1]*A_tokens+[0]*F_tokens], dtype="int32")
...
d_input_ids = cuda.mem_alloc(1 * input_ids.nbytes)
d_attention_mask = cuda.mem_alloc(1 * attention_mask.nbytes)
